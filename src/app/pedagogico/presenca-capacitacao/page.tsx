...
export default function ListaPresencaCapacitacaoPage() {
          ...
          <div key={pageIndex} className={pageIndex > 0 ? "page-break" : ""}>
            <div className="text-center mb-3">
              ...
              <div className="font-bold text-sm mt-2">
                Lista de Presença Capacitação — Aula do Dia&nbsp;&nbsp;{dataFormatada}
              </div>
            </div>
        ...
        <div className="flex-1 flex flex-col bg-[#F8FAFC] overflow-y-auto">
          <div className="bg-white border-b border-slate-200 px-8 py-6 shadow-sm">
            <div className="flex justify-between items-center mb-6">
              <div>
                <h1 className="text-2xl font-bold text-[#133c86] tracking-tight">LISTA DE PRESENÇA CAPACITAÇÃO</h1>
                <p className="text-slate-500 text-sm mt-1">Gere a lista de presença de capacitação para impressão.</p>
              </div>
              {presencaData && (
              ...
              <div className="bg-white rounded-2xl shadow-sm border border-slate-200 overflow-hidden">
                ...
                <div className="overflow-x-auto p-6">
                  <div className="text-center mb-4">
                    ...
                    <div className="font-bold text-sm mt-1">Lista de Presença Capacitação — Aula do Dia {dataFormatada}</div>
                  </div>
